...
#ifndef __H__UG__PLUGINS__LEVEL_SET_CONCENTRATION_VELOCITY_LINKER2__
#define __H__UG__PLUGINS__LEVEL_SET_CONCENTRATION_VELOCITY_LINKER2__
...
namespace ug
{
	namespace NeuroGrowth
	{
		...
		class LSInitialValue
			 : public StdDataLinker<LSInitialValue<TDomain, TAlgebra>, MathVector<TDomain::dim>, TDomain::dim>
		{
			//	domain type
			...
			//	Base class type
			typedef StdDataLinker<LSInitialValue<domain_type, algebra_type>, MathVector<dim>, dim> base_type;

			//	extrapolation type
			typedef IInterfaceExtrapolation<domain_type, algebra_type> extrapol_type;

		public:
			LSInitialValue(SmartPtr<extrapol_type> spExtrapol) : 
		...
		public:
			...
			{
				UG_THROW("LSInitialValue: Element is necessary for the evaluation.");
			}
