...
// 	FV1LevelSetDisc
	{
		...
		reg.add_class_<T>(name, grp)
			...
			.add_method("set_vel_x", static_cast<void (T::*)(SmartPtr<IPData<number,dim> >)>(&T::set_vel_x))
			.add_method("set_vel_y", static_cast<void (T::*)(SmartPtr<IPData<number,dim> >)>(&T::set_vel_y))
			.add_method("set_vel_z", static_cast<void (T::*)(SmartPtr<IPData<number,dim> >)>(&T::set_vel_z))
			.add_method("set_source", static_cast<void (T::*)(SmartPtr<IPData<number,dim> >)>(&T::set_source))
			...
			.add_method("set_dirichlet_data", static_cast<void (T::*)(SmartPtr<IPData<number,dim> >)>(&T::set_dirichlet_data))
