...
#ifndef __H__UG__PLUGINS__LEVEL_SET_INTERFACE_INFLUX_LINKER__
#define __H__UG__PLUGINS__LEVEL_SET_INTERFACE_INFLUX_LINKER__
...
namespace ug
{
   namespace NeuroGrowth
   {
      ...
      class LSInterfaceInflux
          : public StdDataLinker<LSInterfaceInflux<TDomain, TAlgebra>, MathVector<TDomain::dim>, TDomain::dim>
      {
         //	domain type
         ...
         //	Base class type
         typedef StdDataLinker<LSInterfaceInflux<domain_type, algebra_type>, MathVector<dim>, dim> base_type;

         //	extrapolation type
         typedef IInterfaceExtrapolation<domain_type, algebra_type> extrapol_type;

      public:
         LSInterfaceInflux() : m_spExtrapolation(NULL),
